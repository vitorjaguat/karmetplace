          ...
          {isOwner ? (
            <div className="flex gap-1">
              ...
              <Modal
                ...
                classNames={{
                  modal: 'customModal flex items-center rounded-md',
                  modalContainer: 'flex items-center ',
                }}
                center={true}
                showCloseIcon={false}
              >
                <div className="flex flex-col items-center justify-center px-6 pt-6 pb-8 gap-4 bg-zinc-900 border-[1px] border-neutral-700 text-neutral-100 text-sm text-center ">
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="mt-3">
                      ...
                      will be deducted from the total price you set.
                    </div>
                    <div className="">
              ...
              <Modal
                ...
                showCloseIcon={false}
              >
                <div className="flex flex-col items-center justify-center px-6 pt-6 pb-4 gap-2 bg-zinc-900 border-[1px] border-neutral-700 text-neutral-100 text-sm md:text-md text-center overflow-hidden max-w-full">
              ...
              >
                <div className="flex flex-col items-center justify-center px-6 pt-16 pb-6 gap-8 bg-zinc-900 border-[1px] border-neutral-700 text-neutral-100 text-sm md:text-md text-center ">
            ...
            <>
              ...
              >
                <div className="flex flex-col items-center justify-center px-6 pt-6 pb-4 gap-4 bg-zinc-900 border-[1px] border-neutral-700 text-neutral-100 text-sm md:text-md text-center">
                  ...
                  <form className="mt-4 flex flex-col gap-6 w-full items-center">
                    <div className="text-center gap-8 bg-neutral-800 rounded-lg p-6 pt-10 px-10 w-full">
              ...
              >
                <div className="flex flex-col items-center justify-center px-6 pt-6 pb-4 gap-4 bg-zinc-900 border-[1px] border-neutral-700 text-neutral-100">
                  ...
                  <form className="mt-4 flex flex-col gap-6 w-full items-center ">
                    <div className="text-center gap-8 bg-neutral-800 rounded-lg p-6 pt-10 px-10 w-fit shadow-lg shadow-black">
                      <input
                        type="range"
                        name="percentage"
                        id="percentage"
